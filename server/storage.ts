...
export interface IStorage {
  ...
  createEntry(entryData: { title: string; imageUrl?: string; externalLink?: string; artist: string; circleId?: number | null; tags?: string[]; userTags?: string[]; keywords?: string[]; type: 'comic' | 'image' | 'sequence' | 'story' | 'video'; sequenceImages?: string[]; content?: string; userId: number; visibility?: 'public' | 'private' }): Promise<any>;
